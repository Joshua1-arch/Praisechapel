...
const About = () => {
  return (
    <div className="flex flex-col bg-[var(--bg-body)]">
      {/* Hero Section */}
      <section className="relative py-24 md:py-40 bg-[var(--bg-body)] border-b border-[var(--border-color)] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center space-y-8">
          ...
          <h1 className="text-5xl md:text-8xl font-black text-[var(--text-main)] tracking-tight uppercase leading-none">
            Our <span className="text-brand-red">Story</span> & Spirit
          </h1>
          <p className="text-xl text-[var(--text-muted)] max-w-3xl mx-auto leading-relaxed font-medium">
      ...
      <section className="py-24 border-b border-[var(--border-color)]">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-8">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-[var(--text-main)] uppercase tracking-tight">How it all <span className="text-brand-green italic">Began</span></h2>
            <div className="space-y-6 text-[var(--text-muted)] text-lg leading-relaxed font-medium">
              <p>
          ...
          <div className="relative">
            <div className="aspect-square rounded-[3rem] overflow-hidden border border-[var(--border-color)] shadow-2xl">
              <img
      ...
      {/* Mission & Vision */}
      <section className="py-24 bg-[var(--bg-input)]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="p-12 rounded-[3rem] bg-[var(--bg-card)] border border-[var(--border-color)] space-y-8 relative overflow-hidden group">
              ...
              <div className="space-y-4">
                <h3 className="text-3xl font-black text-[var(--text-main)] uppercase tracking-tight">Our Mission</h3>
            ...
            <div className="p-12 rounded-[3rem] bg-[var(--bg-card)] border border-[var(--border-color)] space-y-8 relative overflow-hidden group">
              ...
              <div className="space-y-4">
                <h3 className="text-3xl font-black text-[var(--text-main)] uppercase tracking-tight">Our Vision</h3>
                <p className="text-[var(--text-muted)] text-lg leading-relaxed font-medium">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20 space-y-4">
            ...
            <h3 className="text-4xl md:text-6xl font-black text-[var(--text-main)] uppercase tracking-tight">Statement of <span className="text-brand-green">Faith</span></h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-8 rounded-2xl bg-[var(--bg-card)] border border-[var(--border-color)] hover:border-[var(--border-color)] transition-all group">
                <div className="w-12 h-12 rounded-xl bg-[var(--bg-body)] flex items-center justify-center text-brand-red mb-6 group-hover:bg-brand-red group-hover:text-white transition-all">
                  <belief.icon size={24} />
                </div>
                <h4 className="text-xl font-black text-[var(--text-main)] mb-4 uppercase tracking-tight">{belief.title}</h4>
                <p className="text-[var(--text-muted)] leading-relaxed font-medium">{belief.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-[var(--bg-body)]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            ...
            <h3 className="text-4xl font-black text-[var(--text-main)] uppercase tracking-tight">Ministry Leadership</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="group space-y-6">
                ...
                <div>
                  <h4 className="text-xl font-black text-[var(--text-main)] uppercase tracking-tight">{leader.name}</h4>
