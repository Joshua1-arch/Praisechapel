...
import { Play, Music, FileText, Search, Filter, ChevronRight, Clock, Calendar } from 'lucide-react';
    ...
    <div className="flex flex-col">
      ...
      <section className="relative py-24 md:py-32 bg-zinc-950 overflow-hidden border-b border-zinc-900">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center space-y-6">
          ...
          <div className="max-w-2xl mx-auto flex items-center bg-zinc-900 border border-zinc-800 rounded-2xl p-2 shadow-2xl mt-12 focus-within:border-brand-red transition-all">
            ...
            />
            <button className="bg-brand-green hover:bg-brand-green/90 text-white px-6 py-3 rounded-xl font-black uppercase tracking-widest text-xs transition-all flex items-center gap-2">
              <Filter size={18} />
      ...
      <section className="py-24 bg-zinc-950 border-t border-zinc-900">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: 'The Heart of Worship', speaker: 'Dr. David Solomon', date: 'Jan 11, 2026', img: 'https://images.unsplash.com/photo-1510563393911-372138a37d22?auto=format&fit=crop&q=80&w=800' },
              { title: 'Unwavering Faith', speaker: 'Sarah Solomon', date: 'Jan 4, 2026', img: 'https://images.unsplash.com/photo-1438232992991-995b7058bbb3?auto=format&fit=crop&q=80&w=800' },
              { title: 'Power in Prayer', speaker: 'Michael Chen', date: 'Dec 28, 2025', img: 'https://images.unsplash.com/photo-1544427928-c49cdfebf494?auto=format&fit=crop&q=80&w=800' },
            ].map((msg, i) => (
              <div key={i} className="group bg-zinc-900/50 rounded-3xl overflow-hidden border border-zinc-800 hover:border-brand-red/50 transition-all shadow-xl">
                ...
                <div className="p-8 space-y-4">
                  <div className="flex items-center gap-4 text-zinc-500 text-[10px] font-black uppercase tracking-widest">
                    ...
                    <span className="flex items-center gap-1"><Clock size={12} className="text-brand-red" /> 45 min</span>
                  </div>
