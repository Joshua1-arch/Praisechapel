      ...
      <section className="py-24 bg-zinc-950">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <h2 className="text-4xl font-black text-white uppercase tracking-tight leading-none">Powering the <span className="text-brand-green">Ministries</span></h2>
          ...
          <div className="relative group">
            ...
            <img 
              ...
              className="relative rounded-3xl shadow-2xl border border-zinc-800 grayscale group-hover:grayscale-0 transition-all duration-700"
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-zinc-950 border-t border-zinc-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            ...
            <h3 className="text-4xl font-black text-white uppercase tracking-tight">Channels of Blessing</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className={`group p-10 rounded-[2.5rem] border transition-all ${
                option.highlight 
                ? 'bg-brand-green border-brand-green shadow-2xl shadow-brand-green/20' 
                : 'bg-zinc-900/50 border-zinc-800 hover:border-brand-red/50'
              }`}>
                <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-8 ${
                  option.highlight ? 'bg-white text-brand-green' : 'bg-brand-red/10 text-brand-red'
                }`}>
                  <option.icon size={32} />
                </div>
                <h4 className="text-xl font-black mb-4 text-white uppercase tracking-tight">{option.title}</h4>
                <p className={`mb-8 text-sm font-medium leading-relaxed ${option.highlight ? 'text-zinc-100' : 'text-zinc-400'}`}>{option.desc}</p>
                <button className={`w-full py-4 rounded-xl font-black uppercase tracking-widest text-[10px] transition-all flex items-center justify-center gap-2 active:scale-95 ${
                  option.highlight 
      ...
      <section className="py-24 bg-zinc-950 border-t border-zinc-900">
        <div className="max-w-3xl mx-auto px-6">
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-3xl overflow-hidden shadow-2xl">
            <div className="bg-zinc-900 p-8 flex items-center gap-4 border-b border-zinc-800">
              <Info className="text-brand-red" size={32} />
              <div>
                <h3 className="text-xl font-black text-white uppercase tracking-tight">Covenant Accounts</h3>
                <p className="text-zinc-500 text-xs font-bold uppercase tracking-widest">For bank transfers and wire payments</p>
              </div>
            </div>
            <div className="p-8 space-y-4">
              {[
                ...
                <div key={i} className="flex justify-between items-center py-4 border-b border-zinc-800/50 last:border-0">
                  <span className="text-zinc-500 font-black uppercase tracking-widest text-[10px]">{item.label}</span>
